...
func (in *AdminkubeCfgSecretRef) DeepCopyInto(out *AdminkubeCfgSecretRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminkubeCfgSecretRef.
func (in *AdminkubeCfgSecretRef) DeepCopy() *AdminkubeCfgSecretRef {
	if in == nil {
		return nil
	}
	out := new(AdminkubeCfgSecretRef)
	in.DeepCopyInto(out)
	return out
}
